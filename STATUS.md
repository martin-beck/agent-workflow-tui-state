...
**47 ARs tracked** across 2 active status categories.
...
| --- | --- | --- | --- | --- |
| P0 | [AR-0047](tasks/AR-0047.md): Visible revisable decision selections | codex-awt-ar0047-20260917 | Make accepted decision state explicit and revisable in the live TUI. | Render answered decisions with a checkmark and only the selected proposal while permitting replacement before exit. |
