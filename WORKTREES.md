...
| --- | --- | --- | ---: | --- |
| `agent-workflow-tui` | `feat/ssh-roundtrip-ci` | `094de9771293` | 24 | behind 1, ahead 1 |
...
| `agent-workflow-tui-ar0035` | `feature/ar-0035-scenario-artifact-hardening` | `32dfc428d32c` | 0 | behind 62, ahead 0 |
| `agent-workflow-tui-ar0040` | `feature/ar-0040-terminal-lifecycle-v2` | `be4e8de93fb9` | 0 | behind 55, ahead 0 |
| `agent-workflow-tui-ar0038` | `DETACHED` | `93438838e8a3` | 0 | behind 58, ahead 0 |
| `awtui-ar34.e9He2e` | `DETACHED` | `7928cc5eca0d` | 0 | behind 73, ahead 0 |
